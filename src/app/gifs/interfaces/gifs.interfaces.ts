...
export enum Title {
    DragonBallFightingGIFByTOEIAnimationUK = "Dragon Ball Fighting GIF by TOEI Animation UK",
    DragonBallGIF = "dragon ball GIF",
    DragonBallGIFByTOEIAnimationUK = "Dragon Ball GIF by TOEI Animation UK",
}
...
const typeMap: any = {
    ...
    "Title": [
        "Dragon Ball Fighting GIF by TOEI Animation UK",
        "dragon ball GIF",
